                        ...
                        <form action="../../../../../controllers/shopping.controller.php?request=shopping_car" method="post">
                            <div class="card border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <input name="id_producto" class="form-control border-0 bg-transparent text-center" value="<?php echo $shopping['id_producto'] ?>" readonly>
                                    <!-- <p class="card-text"> <?php //echo $shopping['marca'] ?> </p> -->
